...
This comprehensive guide should take you step by step through:
   ...
   2. [Training an AI model using Pointnet++](https://github.com/C3PO3/fightingFires/blob/main/Train_Pointnet%2B%2B.md) to detect walls, windows, doors, (AI TEAM ADD INFO HERE)
