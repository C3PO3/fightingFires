...
This comprehensive guide should take you step by step through:
   ...
   3. [Connecting the IMU](https://github.com/C3PO3/fightingFires/blob/main/Connecting_IMU.md) and getting access to the VectorNav SDK.
...
To follow this setup guide make sure you have the following:
 ...
 - Have a device with at least 1 TB of data to store training dataset if using stanford pointcloud dataset
 - Have access to the HPC cluster to train your model on GPUs
